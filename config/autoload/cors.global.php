...
return [
    ConfigurationInterface::CONFIGURATION_IDENTIFIER => [
        ...
        'allowed_headers' => ["Authorization", "If-Match", "If-Unmodified-Since", "Content-Type", "Accept", "Origin", "X-Auth-Token", "X-Requested-With", "Access-Control-Allow-Headers", "Access-Control-Allow-Origin", "X-Api-Key"], // No custom headers allowed
